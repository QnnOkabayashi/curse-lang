...
// fn convert_bindings(bindings: &mut bumpalo::collections::Vec<Binding>, cont: &mut dyn FnMut() -> CPSExpr) -> CPSExpr {
//     match bindings.pop() {
//         Some(Binding {
//             variable: lhs,
...
// fn convert_decision_tree<'hir, 'a>(tree: &'a Decision<'hir, 'a>, cont: &mut dyn FnMut(Value) -> CPSExpr) -> CPSExpr {
//     match tree {
